...
public class Test : MonoBehaviour
{
    ...
    IEnumerator EffectUi()
    {
        ...
        while (uiTranspos.sizeDelta.y < sizeY)
        {
            ...
            uiTranspos.sizeDelta = Vector2.Lerp(new Vector2(5.0f, 5.0f),new Vector2(5.0f, sizeY), fTime);
            yield return null;
        }
        ...
        while (uiTranspos.sizeDelta.x < sizeX)
        {
            ...
            uiTranspos.sizeDelta = Vector2.Lerp(new Vector2(5.0f, sizeY), new Vector2(sizeX, sizeY), fTime);
            yield return null;
        }
